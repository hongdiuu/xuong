        ...
        <li class="account-icon"> <a href="#"><span></span></a>
                <div class="header-link-dropdown account-link-dropdown">
                  <ul class="link-dropdown-list">
                    ...
                    <li> <span class="dropdown-title">Thao Tác :</span>
                      <ul>
                      <li><a href="?act=thoat">Đăng Xuất</a></li>
                      </ul>
                    </li>
                    <li> <span class="dropdown-title">Trạng Thái :</span>
                      <ul>
                        <li><a class="active" href="admin/index.php">Truy cập trang admin</a></li>
                      </ul>
                    </li>
                  </ul>
                </div>
              ...
              <li class="account-icon"> <a href="#"><span></span></a>
                <div class="header-link-dropdown account-link-dropdown">
                  <ul class="link-dropdown-list">
                    <li> <span class="dropdown-title">Default welcome msg!</span>
                      <ul>
                        <li><a href="?act=login">Sign In</a></li>
                        <li><a href="?act=dangky">Create an Account</a></li>
                      </ul>
                    </li>
                  </ul>
                </div>

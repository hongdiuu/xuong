  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-5 col-sm-5 mb-xs-30">
        <div class="fotorama" data-nav="thumbs" data-allowfullscreen="native"> <a href="#"><img
              src="images/<?= $image ?>" alt="Honour"></a> <a href="#"><img src="images/2.jpg" alt="Honour"></a> <a
            href="#"><img src="images/3.jpg" alt="Honour"></a> <a href="#"><img src="images/4.jpg" alt="Honour"></a> <a
            href="#"><img src="images/5.jpg" alt="Honour"></a> <a href="#"><img src="images/6.html" alt="Honour"></a> <a
            href="#"><img src="images/4.jpg" alt="Honour"></a> <a href="#"><img src="images/5.jpg" alt="Honour"></a> <a
            href="#"><img src="images/6.html" alt="Honour"></a> </div>
      </div>
            ...
            <div class="product-detail-main">
              <div class="product-item-details">
                ...
                <div class="rating-summary-block">
                  <div class="rating-result"> <span>
                      <?= $detail ?>
                    </span> </div>
                </div>
                <div class="price-box"> <span class="price"> Giá sản phẩm:$
                    <?= $price ?>
                  </span> </div>
                  ...
                  <div class="bottom-detail cart-button">
                    <ul>
                      <li class="pro-cart-icon">
                        ...
                        <a href="<?= $link ?>" class="btn-thue"><span></span> Liên Hệ Sản Phẩm Này</a>
                        </form>
                      </li>
                    </ul>
                  </div>
              ...
              <ul>
                <li>
                  <div class="items-Description selected gray-bg">
                    <div class="Description"> <strong>The standard Lorem Ipsum passage, used since the
                        1500s</strong><br />
                      <p>Proin lectus ipsum, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc.
                        Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean
                        eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus
                        malesuada Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                        has been the industry's standard dummy took a galley of type and scrambled it to make a type
                        specimen book. It has survived not only five centuries, but also the leap into electronic
                        typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release
                        of Letraset sheets</p>
                      <p>Tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et
                        ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor
                        dignissim semper. Nulla luctus malesuada Lorem Ipsum is simply dummy text of the printing and
                        typesetting industry.</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="items-Product-Tags gray-bg"><strong>Section 1.10.32 of "de Finibus Bonorum et Malorum",
                      written by Cicero in 45 BC</strong><br />
                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,
                    totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae
                    dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit,
                    sed quia consequuntur</div>
                </li>
                <li>
            ...
            <div class="item">
              <div class="product-item">
                ...
                <div class="product-item-details">
                  ...
                  <div class="price-box"> <span class="price">$80.00</span> <del class="price old-price">$100.00</del>
                  </div>
                </div>
              </div>
            </div>

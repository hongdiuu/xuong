...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="index.php?act=listdm"></i><span class="app-menu__label">Quản Lý Danh Mục</span></a></li>

      <li><a class="app-menu__item " href="index.php?act=listsp"><span class="app-menu__label">Quản Lý Sản Phẩm</span></a></li>
      
      <li><a class="app-menu__item" href="index.php?act=listtk"><span class="app-menu__label">Quản lý khách hàng</span></a></li>

      <li><a class="app-menu__item" href="index.php?act=notification"><span class="app-menu__label">Quản lý thông tin liên hệ khách hàng</span></a></li>
      ...
      <li><a class="app-menu__item" href="index.php?act=listPost"><i class='app-menu__icon bx bx-repost'></i><span class="app-menu__label">Quản lý Post</span></a></li>
